...
if __name__ == "__main__":
    ...
    #   map_mode=4 represents using the COCO toolbox to calculate the 0.50:0.95 mAP of the current dataset. Prediction results and ground truth boxes need to be obtained first, and pycocotools needs to be installed.
    #-------------------------------------------------------------------------------------------------------------------#
    map_mode        = 0
    #--------------------------------------------------------------------------------------#
