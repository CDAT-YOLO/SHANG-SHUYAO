...
def autopad(k, p=None, d=1):  
    ...
    # Automatically pads the input feature map according to the "Same" principle
    if d > 1:
        # actual kernel-size
...
class C2f(nn.Module):
    ...
    def forward(self, x):
        # Perform a convolution, then split into two parts, each channel is c
...
class SPPF(nn.Module):
    # SPP structure, max pooling with kernel sizes of 5, 9, 13.
